...
export default function ShowProduct() {
 ...
 useEffect(() => {
  ...
  return<>
   ...
   <div className='countainer px-3 grid md:grid-cols-2 grid-cols-1 gap-1  max-md:h-[80vh]  bg-green-300'>
    ...
    {console.log(showProduct)}
        ...
        <h3 className='text-amber-500 text-1.5xl font-semibold py-6 text-2xl'><span className=' font-bold font-serif'>
          price: </span>
